...
<div class="container mt-5" style="margin-left: 250px;">
    ...
    <div class="d-flex justify-content-between mb-3">
        ...
        <input type="text" id="searchPengembalian" class="form-control w-25" placeholder="Cari di Pengembalian..."></input>
    </div>
        ...
        if (mysqli_num_rows($result_pengembalian) > 0) {
            while ($row = mysqli_fetch_assoc($result_pengembalian)) {
                echo "<tr>
                        ...
                        <td>{$row['status']}</td>
                        <td><a href='edit_peminjaman.php?id={$row['id']}' class='btn btn-warning'><i class='fas fa-edit'></i> Edit</a></td>
                    </tr>";
                $no++;
            }
        } else {
